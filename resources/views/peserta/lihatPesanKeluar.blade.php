		...
		<div class="col-md-8">
			<div class="panel">
				<div class="panel-heading">
					<a href="/pesanUserKeluar" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-arrow-left"></i></a>
					<h3>Pesan Keluar</h3>
				</div>
				<div class="panel-body">
					...
					<p>Penerima : {{$pesan->admin->fullname}} | Admin bagian : {{$pesan->admin->privilege}} | E-Mail : {{$pesan->admin->email}}</p>
				        ...
				        <div class="modal-dialog"> 
				            ...
				            <div class="modal-content">
				                <div class="modal-header" style="background-color: #0575e6; color: #fff;">
				                    ...
				                    <h4 class="modal-title"><center>Teruskan Pesan</center></h4>
				                </div>
				                    ...
				                    <form action="/pesanAdmin" method="post" class="form-horizontal" accept-charset="utf-8">
				                    	...
				                    	<div class="form-group" id="penerima">
				                            ...
				                            <div class="col-md-9">
				                            	...
				                            	<select name="admin_id" class="form-control is-invalid" id="penerima">
