		...
		<div class="col-sm-12">
			@if(Auth::user()->verif == NULL)
				<div class="alert alert-warning">
					...
					<p style="text-align: justify; text-justify: inter-word;">Apakah data anda sudah terisi lengkap? Silahkan dilanjutkan dengan pembayaran pendaftaran lomba melalui ATM pada rekening <b>BNI, 0700317808 a.n Sarah Olivia Meily</b>.
