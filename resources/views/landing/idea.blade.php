...
<section id="hero">
    <div class="hero-container wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
      	...
      	<h2>Bangun Bisnis dan Jadilah Agen Perubahan Masyarakat</h2>
      	<div class="actions">
    				...
    				<div class="main-timeline">
    					...
    					<div class="timeline wow fadeInLeft">
    						<div class="timeline-content">
    							...
    							<p class="description text-center">Pembukaan pendaftaran dan pengumpulan berkas</p>
    						</div>
    					</div>
    					...
    					<div class="timeline wow fadeInRight">
    						<div class="timeline-content">
    							...
    							<p class="description text-center">Penutupan pendaftaran</p>
    						</div>
    					</div>
    					...
    					<div class="timeline wow fadeInLeft">
    						<div class="timeline-content">
    							...
    							<p class="description text-center">Batas akhir pengumpulan berkas lomba</p>
    						</div>
    					</div>
		    ...
		    <div class="col-lg-6">
		        <div class="box wow fadeInLeft">
		        	<div class="row">
			          	...
			          	<div class="col-sm-9" style="padding-bottom: 27px;">
