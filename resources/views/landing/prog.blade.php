...
<section id="hero">
    <div class="hero-container wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
      	...
      	<h2>Tunjukkan Kecerdasan Logika dan Seni Codingmu!</h2>
      	<div class="actions">
  	...
  	<div class="container wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms" style="margin-top: 50px; margin-bottom: 50px;">
  		...
  		<center>
	  		<div class="row col-md-9" style="margin-top: 40px;">
	  			<p style="font-size: 16px;">Cabang Lomba Pemrograman merupakan salah satu perlombaan yang ada dalam kegiatan ITCC 2018 yang dikhususkan untuk pelajar tingkat SMA/SMK sederajat Se-Bali.<br>Cabang lomba pemrograman bertujuan untuk menjaring siswa/siswi SMA/SMK ataupun jenjang yang sederajat seluruh Bali yang memiliki kompetensi di bidang komputer khususnya logika komputasi dan pemrograman.<br>Cabang lomba pemrograman merupakan jenis perlombaan individu dengan biaya pendaftaran mulai Rp. 75.000,- untuk setiap peserta.</p>
	  		</div>
	  		<a href="/guidebook/GUIDEBOOK_PEMROGRAMAN_ITCC_2018_v1.0.pdf" class="btn-get-started">Download Guide Book</a>
  		</center>
					...
					<div class="main-timeline">
    					...
    					<div class="timeline wow fadeInLeft">
    						<div class="timeline-content">
    							...
    							<p class="description text-center">Warming up hari pertama</p>
    						</div>
    					</div>
    					...
    					<div class="timeline wow fadeInRight">
    						<div class="timeline-content">
    							...
    							<h2 class="title">Warming Up</h2>
    							<p class="description text-center">Warming up hari terakhir</p>
    						</div>
    					</div>
    					...
    					<div class="timeline wow fadeInRight">
    						<div class="timeline-content">
    							...
    							<p class="description text-center">Babak penyisihan</p>
    						</div>
    					</div>
    					...
    					<div class="timeline wow fadeInLeft">
    						<div class="timeline-content">
    							...
    							<p class="description text-center">Babak final dan penyerahan hadiah</p>
    						</div>
    					</div>
  	...
  	<div class="events-content">
    	<ol>
		    ...
		    <li data-date="12/10/2018">
		        <center>
		          	<em>12 Oktober 2018</em>
		          	<h2 style="color: #000; font-size: 30px;"class="text-black">Warming Up Hari Pertama</h2>
		        </center>
		    </li>
		    <li data-date="19/10/2018">
		        <center>
		          	<em>19 Oktober 2018</em>
		          	<h2 style="color: #000; font-size: 30px;"class="text-black">Warming Up Hari Terakhir</h2>
		        </center>
		    </li>
		    ...
		    <li data-date="01/11/2018">
		        <center>
		          	...
		          	<h2 style="color: #000; font-size: 30px;"class="text-black">Babak Penyisihan</h2>
		        </center>
		    </li>
		    <li data-date="02/11/2018">
		        <center>
		          	<em>2 November 2018</em>
		          	<h2 style="color: #000; font-size: 30px;"class="text-black">Babak Final</h>
		        </center>
		    </li>
    	</ol>
  	</div> <!-- .events-content -->
